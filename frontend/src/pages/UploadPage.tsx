            ...
            <div className="space-y-6 animate-fadeIn">
              ...
              <div className="mt-8 pt-8 border-t border-olive-200">
                <div>
                  ...
                  <p className="text-olive-600 mt-1">Sube 1 PDF o imagen (JPG, JPEG o PNG) del presupuesto</p>
                </div>
              ...
              <div className="mt-8 pt-8 border-t border-olive-200">
                <div>
                  ...
                  <p className="text-olive-600 mt-1">Sube 1 PDF o imagen (JPG, JPEG o PNG) de la factura electrónica</p>
                </div>
